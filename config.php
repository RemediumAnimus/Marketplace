<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/marketplace/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/marketplace/');

// DIR
define('DIR_APPLICATION', 'E:/OpenServer/domains/localhost/marketplace/catalog/');
