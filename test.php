...
$itemId = (isset($_REQUEST['itemId'])) ? $_REQUEST['itemId'] : 35548873381;
...
$url = 'http://otapi.net/OtapiWebService2.asmx/GetProviderInfoList?instanceKey='.CFG_SERVICE_INSTANCEKEY;

$url = 'http://otapi.net/OtapiWebService2.asmx/GetProviderSearchMethodInfoList?instanceKey='.CFG_SERVICE_INSTANCEKEY;

//$url = 'http://otapi.net/OtapiWebService2.asmx/GetRootCategoryInfoList?instanceKey='.CFG_SERVICE_INSTANCEKEY;

//$url = 'http://otapi.net/OtapiWebService2.asmx/GetCategorySubcategoryInfoList?instanceKey='.CFG_SERVICE_INSTANCEKEY.'&parentCategoryId=otc-1';
